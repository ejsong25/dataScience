...
# Load normalized jeonse datasets (onehot encoding, district score method)
jeonse_data_score = pd.read_csv("dataScience/jeonse_dataset_normalized_score.csv")
jeonse_data_onehot = pd.read_csv("dataScience/jeonse_dataset_normalized_onehot.csv")
...
print("<jeonse_dataset_normalized_score - Jeonse dataset Linear Regression Model Evaluation>")
...
print("<jeonse_dataset_normalized_one_hot - Deposit dataset Linear Regression Model Evaluation>")
...
""" 
classification ((Classify deposit according to specific criteria) 
"""
""" Dataset that used score method """

#Calculating Deposit mean, std
...
# Categorizing Deposit According to Classification Criteria
"""
...
print("<jeonse_dataset_normalized_scored - Deposit dataset DecisionTree Model Evaluation>")
...
print("<jeonse_dataset_normalized_one_hot - Deposit dataset DecisionTree Model Evaluation>")
...
for test_size in test_sizes:
    ...
    plt.xlabel("Actual")
    plt.ylabel("Predicted")
    plt.title("Jeonse Deposit Confusion Matrix (one-hot method)")
    plt.show()
